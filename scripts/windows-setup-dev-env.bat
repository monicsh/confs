...
MKLINK "%USERPROFILE%/.local/bin/gitcm" "%USERPROFILE%/code/confs/scripts/gitcm"
MKLINK "%USERPROFILE%/.local/bin/gitr" "%USERPROFILE%/code/confs/scripts/gitr"
MKLINK "%USERPROFILE%/.local/bin/reset-service-fabric-local-cluster" "%USERPROFILE%/code/confs/scripts/reset-service-fabric-local-cluster.ps1"
